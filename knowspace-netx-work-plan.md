...
> **文档版本**：`v1.2.0` | **规划基线**：基于 KnowSpace `v1.5.0` 当前架构与产品定义  
> **算力标定**：已完整标注各功能特性的 **本地 GPU / 显存 / CPU / 云端** 算力分配与动态降级策略  
> **重大调整**：已将 **「高保真 PDF 专业排版与分页导出」** 正式提前至 **`v1.6.x` 里程碑**，作为核心交付特性！
...
```
 ...
 沉浸阅读/零延迟双向编辑     双向链接/图谱/PDF导出    语义检索/混合搜索        AI 知识协作者/开放插件生态
```
...
gantt
    ...
    dateFormat  YYYY-MM
    section v1.6.x Connect (图谱/双链/PDF导出)
...
### 🔗 Milestone 1: KnowSpace v1.6.x —「Connect · 知识互联、多维图谱与 PDF 导出」
> **版本核心**：消除文档孤岛，建立网状双向知识链接与交互式图谱，并提供一站式专业级 PDF 文档排版导出。
