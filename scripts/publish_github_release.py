...
BookMD Reader v1.3.0 正式发布！本次更新精简并重构主题视觉体系，去除了黑曜暗主题，全面升级为 21st.dev Twitter 极客暗黑与日光浅色精选双主题，并移除了顶部多余的主题切换按键。

---

### ✨ 核心更新内容

1. **🎨 21st.dev Twitter 极客暗黑 & 日光浅色 双主题体系**：
   - 采用 Lights Out 纯黑底色 (`#000000`)、电光蓝高亮 (`#1D9BF0`) 与发丝微边框 (`#2F3336`)。
   - 左侧 Activity Bar 支持在 **☀️ 日光浅色 / ✨ Twitter 极客暗黑** 双重主题间平滑切换。
